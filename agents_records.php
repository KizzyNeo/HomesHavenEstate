...
$sql2 = "SELECT id, name, email, phone, bank, acc_no, acc_name, date_created, referrer FROM agents";
$result = $conn->query($sql2);
?>

    <h1 id="welcome_text">Agents' Records</h1>
    <div style="text-align: center;">
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                echo "<tr><td>" . $row["id"]. "</td><td>" . $row["name"]. "</td><td>" . $row["email"]. "</td><td>" . $row["phone"]. "</td><td>" . $row["bank"]. "</td><td>" . $row["acc_no"]. "</td><td>" . $row["acc_name"]. "</td><td>" . $row["date_created"]. "</td><td>" . $row["referrer"]. "</td></tr>";
            }
        } else {
