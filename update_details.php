...
<body style="margin: 0px; color: #206C48;">
    ...
    <div id="lgr-menu" style="color: #206C48; width: 50%;">
        <ul style="float: right; width: 100%;">
            ...
            <a href="inspection.html"><li class="menu_item">Book an Inspection</li></a>
    ...
    height: fit-content; display: none; position: absolute;
     margin-top: 0px; z-index: 999;">
        <ul>
            ...
            <a href="inspection.html"><li>Book an Inspection</li></a>
        ...
        $replace1 = $_REQUEST['others_detail'];
        $replace2 = $_REQUEST['phone_detail'];
        $replace3 = $_REQUEST['email_detail'];
        $replace4 = $_REQUEST['file_detail'];
        $replace5 = $_REQUEST['plots_detail'];
        $replace6 = $_REQUEST['status_detail'];
        if (empty($replace1)) {
        ...
        if (empty($replace6)) {
            ...
            $replace = $replace6;
                ...
                $sql = "UPDATE $db SET $detail = '$replace' WHERE id = $customerID";
                ...
                $sql2 = "SELECT name, plots, plots_bought, status, estate, price, amount_paid, remainder, completed FROM buyers WHERE id = $customerID";
                $result = $conn->query($sql2);
                $row = $result->fetch_assoc();
                $plots_bought = $row['plots_bought'];
